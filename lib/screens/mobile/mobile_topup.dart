...
import 'package:e_wallet/screens/mobile/postpaid_bills.dart';
...
class MobileTopUpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: appBar(context, "Mobile Topup"),
        backgroundColor: Color(0xFFF7F6FB),
        elevation: 0.0,
        leading: IconButton(
        ...
        children: [
          Column(
            children: [
              ...
              Container(
                height: WidgetProperties.screenHeight(context) * 0.19,
                ...
                child: Column(
                  children: [
                    GestureDetector(
                      onTap: () {
                        RouteApp.instance.pushPage(context, PrepaidBillsScreen());
                      },
                      child: Container(
                    ...
                    GestureDetector(
                      onTap: () {
                        RouteApp.instance.pushPage(context, PostpaidBillsScreen());
                      },
                      child: Container(
